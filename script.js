...
const objects = ["웃음을😀", "용기를🦁", "휴식을🛋️", "취미를🎨", "뱃살을🤰", "건강을🏃‍♂️", "설렘을💕", "맛집을🍽️", "모험을🧭", "추억을📸", "늦잠을🛌", 
    "공부를📚", "여행을✈️", "휴가를🏝️", "매력을😍", "샤워를🚿", "나눔을🤲", "배려를👐", "노력을💪", "연휴를🎉", "생각을💭", "열일을🔥", "칼퇴를🏃‍♂️", 
    "할일을📝", "시간을⏰", "나다움을💖", "달콤함을🍭", "새로움을🌈", "짜릿함을⚡", "자신감을💪", "반짝임을✨", "즐거움을😊", "신선함을🍃", "재활용을♻️", 
    "짝사랑을💘", "기억을💭", "잔고를💰", "두근거림을❤️", "안정감을🛡️", "시작을🚀", "친구를👫", "새로움을🌈", "차분함을🧘‍♂️", "나른함을😌", "기회를🎲", 
    "희망을🌟", "에너지를🔋", "게임을🎮", "노래를🎤", "열일을🔥", "칼퇴를🏃‍♂️", "느긋함을😌", "놀라움을😲", "나다움을💖"];
